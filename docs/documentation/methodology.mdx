...
:::note
Currently Floor data are being updated in near-real time. Please note that Floor data are syncing with a 15 minute delay. This was necessary to account for the blockchain block reorganization
:::
