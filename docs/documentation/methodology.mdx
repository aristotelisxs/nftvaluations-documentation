...
NFTi is a combination of adjusted floor market cap and our valuations powered by machine learning. NFTi is currently calculated as the Average of Adjusted Floor and ML Valuation of each token. The Market Cap is the sum of tokens’ NFTi.
